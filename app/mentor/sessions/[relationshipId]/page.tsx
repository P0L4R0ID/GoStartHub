...
import { MessageSquare, Upload, FileText, Send, Download, Edit, ArrowLeft, Users, Video, Calendar, Clock, Check, X, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function MentorSessionPage({ params }: { params: { relationshipId: string } }) {
    ...
    const fetchData = async () => {
        await Promise.all([fetchMessages(), fetchFiles(), fetchNotes(), fetchScheduledCalls()]);
        setLoading(false);
    };
                        ...
                        <TabsContent value="chat">
                            <Card className="border-2 border-blue-200">
                                <CardHeader className="bg-gradient-to-r from-blue-50 to-white border-b-2 border-blue-200">
                                    ...
                                    <CardDescription>Communicate with your mentor/mentee</CardDescription>
                                </CardHeader>
                                        ...
                                        {!inCall ? (
                                            <div className="text-center py-8">
                                                ...
                                                <p className="text-sm text-muted-foreground mb-4">
                                                    Start an instant video call with your mentee.
                                                </p>
                                                <Button
                                                    size="lg"
